...
@media only screen and (max-width:640px) {
	...
	div#overlayContent{padding:0rem 2rem; margin-bottom: 1rem; }
...
@media only screen and (min-width : 640px) {
	div#overlayContent{padding:1.5rem 3rem;  margin-bottom: 1.5rem; line-height: 1.5; background-color:rgba(255,255,255,.75);}
}
